...
$l['no_backups'] = "De momento ainda não foram efectuados backups.";
...
$l['chmod_info'] = "Por favor altere as configurações CHMOD para uma especificada no ficheiro em baixo. Para mais informações em como efectuar o CHMOD, veja o";
$l['file'] = "Ficheiro";
$l['location'] = "Localização";
$l['settings_file'] = "Definições do Ficheiro";
$l['config_file'] = "Configuração do Ficheiro";
$l['file_upload_dir'] = "Directoria de Ficheiros Enviados";
$l['avatar_upload_dir'] = "Directoria de Avatares Enviados";
$l['language_files'] = "Ficheiros de Idioma";
$l['backup_dir'] = "Directoria de Backups";
$l['cache_dir'] = "Directoria de Cache";
$l['themes_dir'] = "Directoria de Temas";
$l['chmod_files_and_dirs'] = "CHMOD Ficheiros e Directorias";
...
$l['check_templates_info'] = "Este processo vai verificar os seus templates contra problemas de segurança que possam afectar o seu fórum e o servidor onde ele corre. Isto pode demorar um pouco se você tiver instalado muitos Temas.
...
$l['error_chmod'] = "dos ficheiros e directorias necessárias não têm as configurações adequadas de CHMOD.";
$l['error_invalid_table'] = "A tabela especificada não existe.";
$l['error_db_encoding_not_set'] = "As suas definições actuais do MyBB não estão configuradas para usar esta ferramenta ainda. Por favor veja o <a href=\"http://docs.mybb.com/Utf8_setup.html\">MyBB Docs</a> para mais informações em como configurar.";
$l['error_not_supported'] = "O motor da sua base de dados actual não é suportado pela ferramenta de conversão UTF-8.";
$l['error_invalid_input'] = "Ocorreu um problema ao verificar o Template. Por favor tente outravez ou contacte o Grupo MyBB para suporte.";
$l['error_master_templates_altered'] = "Os Templates Principais foram alterados. Pr favor contacte o Grupo MyBB para suporte de como altera-lo.";
...
$l['success_chmod'] = "Todos os ficheiros e directorias necessários estão com as configurações CHMOD correctas.";
?>