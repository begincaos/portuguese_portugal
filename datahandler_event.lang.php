...
$l['eventdata_missing_name'] = 'Está a faltar o nome do evento, por favor insira-o.';
$l['eventdata_missing_description'] = 'Está a faltar a descrição do evento, por favor insira-a.';
...
$l['eventdata_invalid_start_year'] = "Só podem ser criados eventos nos próximos 5 anos. Por favor, escolha um ano inicial para o evento que seja válido.";
$l['eventdata_invalid_start_month'] = 'O mês inicial escolhido não é válido, escolha um que o seja por favor.';
...
$l['eventdata_invalid_end_year'] = "Só podem ser criados eventos nos próximos 5 anos. Por favor, escolha um ano f para o evento que seja válido.";
$l['eventdata_invalid_end_month'] = 'O mês final escolhido não é válido, escolha um que o seja por favor.';
...
$l['eventdata_invalid_repeat_weekly_days'] = "Não seleccionou nenhuns dias da semana para o evento ocorrer.";
