...
// Erros
$l['error_nothing_selected'] = "Por favor seleccione um ou mais anexos para apagar.";
...
$l['error_not_all_removed'] = "Apenas alguns anexos órfãos foram apagados com sucesso, outros não podem ser removidos da directoria uploads.";
$l['error_invalid_username'] = "O nome de utilizador que inseriu é inválido.";
$l['error_invalid_forums'] = "Um ou mais fóruns que seleccionou é inválido.";
$l['error_no_results'] = "Não foram encontrados anexos com os critérios de pesquisa especificado.";
$l['error_not_found'] = "Arquivo anexado não pôde ser encontrado na directoria de uploads.";
...
// Sucesso
$l['success_deleted'] = "Os anexos seleccionados foram apagados com sucesso.";
$l['success_orphan_deleted'] = "Os anexos órfãos seleccionados foram apagados com sucesso.";
$l['success_no_orphans'] = "Não existem anexos órfãos no seu fórum.";

// Confirmar
$l['confirm_delete'] = "Tem a certeza que quer apagar os anexos seleccionados?";
...
$l['step_line2'] = "Você vai ser automaticamente redireccionado para o próximo passo, assim que este processo for concluído.";
